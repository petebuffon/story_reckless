...
def anchor_upload(episode, input_path):
    ...
    with webdriver.Firefox(options=options) as driver:
        ...
        time.sleep(5)
        save_changes = wait.until(element_to_be_clickable((By.XPATH, "//*[contains(text(), 'Save episode')]")))
        save_changes.click()
        form = wait.until(presence_of_element_located((By.TAG_NAME, "form")))
        print("adding metadata")
        form.find_element(By.XPATH, "//*[contains(text(), 'Switch to HTML')]").click()
        ...
        publish_now = wait.until(element_to_be_clickable((By.XPATH, "//*[contains(text(), 'Publish now')]")))
        publish_now.click()
